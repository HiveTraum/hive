...
type Environment struct {
	...
	AccessTokenLifetime  time.Duration `env:"ACCESS_TOKEN_LIFETIME" envDefault:"15"`    // Minutes
	RefreshTokenLifetime time.Duration `env:"REFRESH_TOKEN_LIFETIME" envDefault:"30"`   // Days
	ActualSecretLifetime time.Duration `env:"ACTUAL_SECRET_LIFETIME" envDefault:"1440"` // Minutes
}
